...
def main():
    ...
    # better_draw_circles(rg.Point(-50, 200), 4)
    # even_better_draw_circles(rg.Point(50, 40), 10, 6, 'red', 5)
    even_better_draw_circles(rg.Point(50, 100), 15, 10, 'pink', 20)
    even_better_draw_circles(rg.Point(-50, 100), 15, 3, 'blue', 20)
    even_better_draw_circles(rg.Point(50, 100), 15, 3, 'blue', 20)
    colin = rg.SimpleTurtle()
    colin.pen = rg.Pen('brown', 3)
    colin.forward(80)
    even_better_draw_circles(rg.Point(0, 25), 1, 10, 'brown', 2)
...
def better_draw_circles(point, increasingcircles):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        # Go DOWN 15 pixels, ending up pointing east again
        turtle.right(90)
        turtle.forward(increasingcircles)
        turtle.left(90)

        turtle.pen_down()
        turtle.draw_circle(increasingcircles * k)  # Radius 15, 30, 45, 60, ...
...
def even_better_draw_circles(point, increasingcircles, numbercircles, colorcircles, thicknesscircles):
    ...
    rosie.pen = rg.Pen(colorcircles, thicknesscircles)
    rosie.pen_up()
    rosie.go_to(point)
    rosie.set_heading(0)
    for k in range(1, numbercircles + 1):

        rosie.pen_up()

        rosie.right(90)
        rosie.forward(increasingcircles)
        rosie.left(90)
        rosie.pen_down()
        rosie.draw_circle(increasingcircles * k)
