...
def try_methods_and_functions():
    mom = rg.SimpleTurtle()
    mom.pen = rg.Pen('blue', 5)
    mom.backward(150)
    mom.speed = 1
    draw_many_squares(mom, 2, 100, 30)
    mom.speed = 5
    mom.pen = rg.Pen('red', 5)
    draw_many_squares(mom, 10, 50, 15)
    mom.speed = 100
    mom.pen = rg.Pen('red', 35)
    draw_many_squares(mom, 8, 300, 60)
    mom.pen = rg.Pen('black', 3)
    mom.backward(200)
    mom.draw_circle(30)
    mom.draw_square(50)
